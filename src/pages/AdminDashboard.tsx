...
import { FileText, Download, Users, DollarSign, TrendingUp, Search } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const totalRevenue = displayInvoices.reduce((sum, invoice) => sum + invoice.amount, 0);
  const paidInvoices = displayInvoices.filter(invoice => invoice.status === 'paid').length;
  const pendingInvoices = displayInvoices.filter(invoice => invoice.status === 'pending').length;
    ...
    <div className="min-h-screen bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Manage all clients, invoices, and business operations</p>
        </div>
        ...
        <Tabs defaultValue="invoices" className="space-y-6">
          ...
          <TabsContent value="invoices" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-semibold text-foreground">All Invoices</h2>
          ...
          <TabsContent value="users" className="space-y-6">
            ...
            <div className="grid gap-6">
              {filteredUsers.map((user) => (
                <Card key={user.id} className="shadow-medium hover:shadow-strong transition-all duration-300">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        <CardTitle className="flex items-center gap-2">
